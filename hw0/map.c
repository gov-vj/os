...
int main (int argc, char *argv[]) {
    ...
    char *buf3 = malloc(100); /* dynamically allocate some stuff */
    char *buf4 = malloc(100); /* and some more stuff */
    char *buf5 = malloc(100); /* dynamically allocate some stuff */
    char *buf6 = malloc(100); /* and some more stuff */
    ...
    printf("Heap: malloc 4: %lx\n", (long unsigned int) buf4);
    printf("Heap: malloc 5: %lx\n", (long unsigned int) buf5);
    printf("Heap: malloc 6: %lx\n", (long unsigned int) buf6);
    recur(3);
    return 0;
}
